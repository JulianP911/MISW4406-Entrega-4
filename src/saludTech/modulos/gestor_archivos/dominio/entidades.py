...
class ImagenMedica(AgregacionRaiz):
    ...
    def crear_imagen_medica(self, imagenMedica: ImagenMedica, id_paciente: str):
        ...
        self.bucket_location = imagenMedica.bucket_location

        self.agregar_evento(
            ArchivoPublicado(id=self.id, url=self.url, id_paciente=id_paciente)
        )

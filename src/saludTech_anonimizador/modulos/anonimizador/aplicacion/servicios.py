from saludTech_anonimizador.seedwork.aplicacion.servicios import Servicio
...
from saludTech_anonimizador.modulos.anonimizador.dominio.fabricas import (
    FabricaImagenMedica,
)
from saludTech_anonimizador.modulos.anonimizador.infraestructura.fabricas import (
    FabricaRepositorio,
)

from saludTech_anonimizador.seedwork.infraestructura.uow import UnidadTrabajoPuerto as uow
